...
<div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
    ...
    <p class="text-white py-4">
        I'm PinguSurMars_ (or Pingu for short) and I make stuff in whatever language I feel like using at the time.</p>
    <p class="text-white py-2">
        I mostly game or watch YouTube in my free time, and I sometimes decide randomly to code
        random stuff like this website for no particular reason. (I'm writing this at 00:11 CEST on a Wednesday Morning
        with class the next day)</p>
    <p class="text-white py-2"><a class="underline decoration-1" href="https://github.com/pingusurmars/docker-compose-stack">
